...
const SortList = () => {
  ...
  return (
    <div className="h-full min-w-36 xs:w-72 relative" ref={dropdownRef}>
      <button
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-64 lg:w-full absolute right-0 z-20 bg-white rounded-10 shadow-review overflow-hidden mt-3.5"
          >
            <ul>
              {options.map((option) => (
                <li
