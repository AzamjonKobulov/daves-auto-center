...
const MessagePoppup: React.FC<{ onToggleMessage: () => void }> = ({
  onToggleMessage,
}) => {
  return (
    <motion.div
    ...
    >
      <div className="max-w-5xl w-full relative flex items-center justify-center bg-white text-brand-dark rounded-10 lg:rounded-20 shadow-privacy py-10 sm:py-16 lg:pt-28 lg:pb-40 px-7">
        <button
        ...
        <div className="max-w-2xl w-full space-y-10 lg:space-y-16 text-center">
