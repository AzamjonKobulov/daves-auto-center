...
const WhoIsTyson: React.FC<WhoIsDaveProps> = ({
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 sm:grid place-content-center z-[60] overflow-auto sm:overflow-visible sm:bg-black/50 sm:px-5"
      onClick={onToggleDave}
    >
      <div
        className="sm:w-4/5 lg:w-auto mx-auto lg:mx-0 lg:max-w-4xl xl:max-w-5xl w-full sm:relative bg-white sm:rounded-10 lg:rounded-20 shadow-privacy overflow-auto sm:my-5 pt-14 sm:pt-16 px-5 pb-5 md:p-10 xl:p-sixty"
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
        <div className="grid lg:grid-cols-2 gap-8 xl:gap-16">
          ...
          <div className="flex flex-col gap-6 lg:pb-10 xl:pb-0">
            <div className="h-3/5 aspect-square sm:aspect-auto rounded-10 overflow-hidden">
              <Image
                src="/assets/images/img-dave-2.jpg"
                alt="Tyson"
                width={400}
                height={700}
